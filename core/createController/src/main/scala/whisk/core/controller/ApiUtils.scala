...
import whisk.core.createController.PostProcess.PostProcessEntity
...
protected[createController] object FilterEntityList {
   ...
   * all others.
   */
  protected[createController] def filter(resources: List[JsValue],
