...
package whisk.core.createController.actions
...
import whisk.core.createController.RejectRequest
import whisk.core.createController.WhiskServices
...
protected[core] trait PostActionActivation extends PrimitiveActions with SequenceActions {
   ...
   */
  protected[createController] def invokeAction(
    user: Identity,
    action: WhiskAction,
