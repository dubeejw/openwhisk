 ...
 */
protected[createController] class SwaggerDocs(apipath: Uri.Path, doc: String)(implicit actorSystem: ActorSystem)
    extends Directives {
...
protected[createController] object RestApiCommons {
 ...
 * Useful for CORS.
 */
protected[createController] trait RespondWithHeaders extends Directives {
...
class RestAPIVersion(config: WhiskConfig, apiPath: String, apiVersion: String)(
  ...
  protected[createController] class WebActionsApi(override val webInvokePathSegments: Seq[String],
