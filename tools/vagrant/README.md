...
**Tip:** You need to use the `-i` switch as the default SSL certificate used by
...
**Tip** Do not restart the VM using Virtual Box tools, and always use `vagrant`
...
**Tip**: Don't use `vagrant resume`. See
