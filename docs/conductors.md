...
If a component action itself is a sequence or conductor action, the logs contain
...
6.  Because the output of the last secondary _tripleAndIncrement_ activation
